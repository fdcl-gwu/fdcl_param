...
template void fdcl_param::read(const string param_name, Eigen::MatrixBase< Eigen::Matrix <double,3,1> >& M);
template void fdcl_param::read(const string param_name, Eigen::MatrixBase< Eigen::Matrix <double,4,1> >& M);

template void fdcl_param::save(const string param_name, Eigen::MatrixBase< Eigen::Matrix <double,3,3> >& M);
template void fdcl_param::save(const string param_name, Eigen::MatrixBase< Eigen::Matrix <double,3,1> >& M);
template void fdcl_param::save(const string param_name, Eigen::MatrixBase< Eigen::Matrix <double,4,1> >& M);
